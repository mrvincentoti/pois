...
from ..app import app
from .controllers import add_activity, get_activities, get_activity, edit_activity, delete_activity, restore_activity, get_activities_by_org
...
@app.route("/list-org-activities/<org_id>", methods=['GET'])
def org_activities(org_id):
   if request.method == 'GET': return get_activities_by_org(org_id)
   else: return 'Method is Not Allowed'  
