	...
	return (
		<div className="card card-height-100">
			<div className="card-header align-items-center d-flex">
				<h4 className="card-title mb-0 flex-grow-1">Up-coming Retirements</h4>
											...
											<div className="d-flex align-items-start">
												...
												<div className="flex-grow-1">
													<label className="form-check-label mb-0 ps-2 p-1">
														{`${item.first_name} ${item.last_name} - (${item.directorate?.name})`}
													</label>
												...
												<div className="flex-shrink-0 ms-2">
													<p className="text-muted fs-12 mb-0">
														{formatDate(item.retirement_date, 'D MMM, YYYY')}
													</p>
												</div>
											</div>
										</a>
