			...
			<div className="modal-body">
				<div className="row g-3">
							...
							<tbody>
								...
								{activity?.crime && (
									<tr>
										...
										<td>
											<span className="text-muted">{activity?.crime.name}</span>
										</td>
									</tr>
								)}
								...
								{activity?.comment && (
									<tr>
										...
										<td>
											<span className="text-muted">{activity?.comment}</span>
										</td>
									</tr>
								)}
							</tbody>
									...
									<tbody>
										{activity?.items?.length > 0 ? (
											activity.items.map((item, index) => (
												<>
													<tr key={index}>
														<td className="text-black">{item?.item_name}</td>
														<td>
															<span className="text-muted">
																{item?.qty || 'N/A'}
															</span>
					...
					{activity?.media_files?.length > 0 ? (
						...
						<p className="form-control-plaintext">No media files available</p>
					)}
				</div>
			</div>
		</ModalWrapper>
