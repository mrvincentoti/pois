...
import { FETCH_ARMS_API, CREATE_ARMS_RECOVERED_API, UPDATE_ARMS_RECOVERED_API } from '../../services/api';
...
const NewEditArms = ({ closeModal, data, update }) => {
    ...
    const onSubmit = async (values, form) => {
        try {
            ...
            const uri = data ? `${UPDATE_ARMS_RECOVERED_API}/${data.id}` : CREATE_ARMS_RECOVERED_API;
                                    ...
                                    <Field id="arm_id" name="arm_id">
                                        {({ input, meta }) => (
                                            <Select
                                                ...
                                                options={armsOptions}
                                                value={Array.isArray(armsOptions) ? armsOptions.find(option => option.id === input.value) : null}
