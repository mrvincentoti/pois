								...
								<div className="card-body p-4">
									<div className="d-flex">
										<div className="flex-grow-1 text-muted overflow-hidden">
											...
											<p className="text-muted text-truncate mb-0">
												Casualties Recorded :{' '}
												<span className="fw-semibold text-body">50</span>
											</p>
											<p className="text-muted text-truncate mb-0">
												Arresting Body :{' '}
												<span className="fw-semibold text-body">APS</span>
											</p>
											<p className="text-muted text-truncate mb-0">
												Place Of Detention :{' '}
												<span className="fw-semibold text-body">San Jose</span>
											</p>
											<p className="text-muted text-truncate mb-0">
												Action Taken :{' '}
												<span className="fw-semibold text-body">
								...
								<div className="card-body p-4">
									<div className="d-flex">
										<div className="flex-grow-1 text-muted overflow-hidden">
											<h5 className="fs-14 text-truncate">
												<a href="#" className="text-body">
													Stealing of 2000 Create Of Eggs
												</a>
											</h5>
											<p className="text-muted text-truncate mb-0">
												Crime Date :{' '}
								...
								<div className="card-body p-4">
									<div className="d-flex">
										<div className="flex-grow-1 text-muted overflow-hidden">
											<h5 className="fs-14 text-truncate">
												<a href="#" className="text-body">
													Stealing of 2000 Crates Of Eggs
												</a>
											</h5>
											<p className="text-muted text-truncate mb-0">
												Crime Date :{' '}
