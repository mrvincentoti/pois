...
import {DeleteButton, EditButton, ViewButton, ViewButtonPosting} from '../../components/Buttons';
...
const Postings = () => {
	...
	const fetchPostings = useCallback(async (per_page, page, q,  filters='') => {
		try {
			...
			const rs = await request(FETCH_EMPLOYEE_POSTINGS_BY_EMPLOYEE_API.replace(':id', params.id));
		...
		<div className="container-fluid">
			...
			<div className="row">
				<div className="col-lg-12">
					<div className="card">
						<TitleSearchBar
							title={`Posting History - ${formatFullName(employeeData)}`}
							onClick={() => addPosting()}
							...
							linkTo={`/employees/postings`}
							createBtnTitle="Back to Postings"
