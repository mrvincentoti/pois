...
import {
	formatCadre,
	formatDate,
	formatDateWord, formatDateYear,
	formatFullName,
	formatGetInitialsName,
} from '../../services/utilities';
import { useEffect, useState } from 'react';
const EmployeePrint = ({ employeeData }) => {
							...
							<div className="row g-2 mb-3">
								<div className="col-12">
									...
									<div className="d-flex align-items-center">
										<div className="mb-4 pb-2 w-100">
											<h5 className="card-title text-decoration-underline mb-3 setRight">
												<a href={`/promotions/${employeeData?.id}`}>CAREER PROGRESSION</a>
											</h5>
													...
													<div className="flex-grow-3">
														<h6 className="fs-14 mb-1"> •{' '}GL.
															...
															{employeeData?.date_of_appointment
																	...
																	: 'N/A'}
															-{' '}
																{employeeData?.cadre? formatCadre(employeeData.cadre.id)
																	: 'N/A'}
																</h6>
													</div>
												</div>
											...
											{employeeData?.stagnation===3
													...
													<h6 className="fs-14 mb-2">
														<span className="text-muted">
															 <>Stagnated at Current Rank- {employeeData?.rank
														? ` GL.${employeeData.rank.level} (${employeeData.rank.name})`
														: 'N/A'} </>
									...
									<div className="d-flex align-items-right">
										<div className="mb-4 pb-2 w-100">
											<h5 className="card-title text-decoration-underline mb-3 setRight">
												<a href={`/deployments/${employeeData?.id}`}>DEPLOYMENTS</a>
											</h5>
									...
									<div className="d-flex align-items-center">
										<div className="mb-4 pb-2 w-100">
											<h5 className="card-title text-decoration-underline mb-3 setRight">
												<a href={`/trainings/${employeeData?.id}`}>TRAININGS & SKILLS</a>
											</h5>
									...
									<div className="d-flex align-items-center">
										<div className="mb-4 pb-2 w-100">
											<h5 className="card-title text-decoration-underline mb-3 setRight">
												<a href={`/employee-posting/${employeeData?.id}`}>POSTING HISTORY</a>
											</h5>
									...
									<div className="d-flex align-items-center">
										<div className="mb-4 pb-2 w-100">
											<h5 className="card-title text-decoration-underline mb-3 setRight">
												<a href={`/awards/${employeeData?.id}`}>AWARDS & ACHIEVEMENTS</a>
											</h5>
									...
									<div className="d-flex align-items-center">
										<div className="mb-4 pb-2 w-100">
											<h5 className="card-title text-decoration-underline mb-3 setRight">
												<a href={`/sanctions/${employeeData?.id}`}>DISCIPLINARY CASES</a>
											</h5>
